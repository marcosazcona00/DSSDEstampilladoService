...
function validateCognitoJwtFields(payload, options) {
    ...
    if (options.groups != null) {
        assertStringArraysOverlap("Cognito group", payload["cognito:groups"], options.groups);
    }
    // Check token use
    ...
    if (options.clientId !== null) {
        ...
        if (payload.token_use === "id") {
            assertStringArrayContainsString('Client ID ("audience")', payload.aud, options.clientId);
        }
        else {
            assertStringArrayContainsString("Client ID", payload.client_id, options.clientId);
        }
    }
}
/**
