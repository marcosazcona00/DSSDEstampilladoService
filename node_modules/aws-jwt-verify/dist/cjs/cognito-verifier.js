...
function validateCognitoJwtFields(payload, options) {
    ...
    if (options.groups != null) {
        (0, assert_js_1.assertStringArraysOverlap)("Cognito group", payload["cognito:groups"], options.groups);
    }
    // Check token use
    (0, assert_js_1.assertStringArrayContainsString)("Token use", payload.token_use, [
        "id",
        "access",
    ]);
    if (options.tokenUse !== null) {
        ...
        (0, assert_js_1.assertStringEquals)("Token use", payload.token_use, options.tokenUse);
    }
    ...
    if (options.clientId !== null) {
        ...
        if (payload.token_use === "id") {
            (0, assert_js_1.assertStringArrayContainsString)('Client ID ("audience")', payload.aud, options.clientId);
        }
        else {
            (0, assert_js_1.assertStringArrayContainsString)("Client ID", payload.client_id, options.clientId);
        }
    }
}
/**
